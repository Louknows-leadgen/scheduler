		...
		while($row = mysqli_fetch_array($result))
         {
			 ...
			 $resultemp = mysqli_query($con,"SELECT firstname, lastname, employeeid, periodrate from prlemployeemaster 
		...
		while($row = mysqli_fetch_array($result))
         {
			 ...
			 $resultemp = mysqli_query($con,"SELECT firstname, lastname, employeeid from prlemployeemaster 
									  WHERE employeeid='".$row['employeeid']."'");
			 $rowemp = mysqli_fetch_array($resultemp);
