...
if($_POST['shiftname']!='')
{
	...
	$lunchending=$_POST['lunchendhour'].":".$_POST['lunchendmin'].":00";
...
$lunchendtime=explode(":",$rowsched['lunchend']);
...
//echo $rowsched['groupschedulename'];
	...
	<table border="0" bgcolor="#FFFFFF">
	  ...
	  <tr>
		...
		<td>Lunch End:</td>
		<td>
			<select name="lunchendhour" />
			<?php
			for($x=0;$x<25;$x++){
				if($x<10){ $x="0".$x; }
			?>
				<option <?php if($lunchendtime[0]==$x) { echo 'selected="selected"';} ?>><?php  echo $x; ?></option>
			<?php
			}
			?>
			</select>
			<select name="lunchendmin">
				<option <?php if($lunchendtime[1]=='00') { echo 'selected="selected"';} ?>>00</option>
				<option <?php if($lunchendtime[1]=='15') { echo 'selected="selected"';} ?>>15</option>
				<option <?php if($lunchendtime[1]=='30') { echo 'selected="selected"';} ?>>30</option>
				<option <?php if($lunchendtime[1]=='45') { echo 'selected="selected"';} ?>>45</option>
			</select>
		</td>        
	  </tr>
	  <tr>
