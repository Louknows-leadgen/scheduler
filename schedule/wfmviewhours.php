...
<form action="wfmtransferhours.php" method="post">
	<table border="1" cellpadding="2">
		...
		$gettimes="select timelog.*,prlemployeemaster.employeeid,prlemployeemaster.schedule from timelog,prlemployeemaster where prlemployeemaster.employeeid=timelog.userid and timelog.userid='".$_POST['employeeid']."' and timelog.dates>='".$starting."' and timelog.dates<='".$ending."'";
//echo $gettimes;
...
<tr><td colspan="11" align="right">
	...
	<input type="hidden" value="<?php echo $year?>-<?php echo $month?>-<?php echo $payperiod?>" name="payperiod" />
