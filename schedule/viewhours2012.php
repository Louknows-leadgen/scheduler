...
//echo $todayworkinghourswithoutnightdiff."<br> ";
	...
	if($early>10 || $early=='' || $early<=0){
	 ...
	 if($rowtimelogs['status']=='6th day OT'){
			...
			?> 
			<tr <? if($rowtimelogs['status']=='Vacation Leave' || $rowtimelogs['status']=='Wedding Leave' || $rowtimelogs['status']=='6th day OT' || $rowtimelogs['status']=='HOLI'){ echo "bgcolor='yellowgreen'";}?>  onMouseOver="this.className='highlight'" onMouseOut="this.className='normal'">
